...
<body>
	...
	<div id="menu">
		...
		<div id="play">
			PLAY <a href="http://localhost:8082/Multiplayer2/play.jsp"><img
				alt="" src="button-g44a203ffa_1280.png"></a>
		</div>
		<div id="button">
			<div class="b">
				<div class="a">
					<a href="http://localhost:8082/Multiplayer2/add.jsp">ADD SONG</a>
				</div>
			</div>
			<div class="b">
				<div class="a">
					<a href="http://localhost:8082/Multiplayer2/delete.jsp">REMOVE
						SONG</a>
				</div>
			</div>
			...
			<div class="b">
				<div class="a">
					<a href="http://localhost:8082/Multiplayer2/update.jsp">UPDATE
						SONG</a>
				</div>
			</div>
			<div>
				<a class="a" href="http://localhost:8082/Multiplayer2/SongList.jsp"><button>SONG
						LIST</button></a>
			</div>
		</div>
	...
	try {
		...
		PreparedStatement preparedStatement = connection.prepareStatement("select * from multiplayer1 where id=?");
