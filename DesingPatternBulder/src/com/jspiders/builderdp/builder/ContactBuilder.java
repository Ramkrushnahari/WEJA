package com.jspiders.builderdp.builder;
...
public class ContactBuilder {
	...
	public Contact getContact() {
		Contact contact = new Contact(this.first_name, this.middle_name, this.last_name, this.nickname, 
				this.email, this.mobile_no, this.landline_no, this.dob, this.company, this.address, this.gender);
		return contact;
